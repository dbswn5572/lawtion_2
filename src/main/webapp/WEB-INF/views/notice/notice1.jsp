...
<body>
	...
	<a href="${pageContext.request.contextPath}/notice.do"><button class="noticebt1">NOTICE</button></a>
	<a href="${pageContext.request.contextPath}/news.do"><button class="noticebt2">NEWS</button></a>
	</div>
	<div class="notice">
		<table>
			<tr class="theme">
