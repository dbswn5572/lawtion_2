...
<script>
	$(document).ready(function(){
		...
		jQuery('#ampaginationsm').on('am.pagination.change',function(e){
	           ...
	           $(location).attr('href', "${pageContext.request.contextPath}/review_board_action.do?rpage="+e.page);         
	    });
	...
	<div class="review">
		...
		<nav class="review-select">
			<div class="select">
				<ul>
					...
					<li class="select1"><a href="${pageContext.request.contextPath}/review_board_action.do">역경매</a></li>
		...
		<div class="review-allbest">
			...
			<table border=0 class="best">
				<c:forEach items = "${actionbestlist}" var = "vo">
				<tr>
					<td>${vo.rno }</td>
