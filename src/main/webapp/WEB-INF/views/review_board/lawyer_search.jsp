<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="lawtion.vo.SearchVO, lawtion.dao.SearchDAO, java.util.*"%>
...
<script type="text/javascript">
	function popupClose(form){
		...
		form.submit();
		alert(opener.document.form.getElementById("lawyersearch").val());
		if(opener!=null){
			opener.insert = null;
...
<body>
	<div class= "lawyersearchContent">
		<form name="searchinput" action="lawyer_search_check.do" method="POST">
		<table border=0 class="searchinput">
			...
			<td><button type="reset" name="searchbutton1"><img src ="${pageContext.request.contextPath}/images/close.png" width="30" height="30" ></button></td>
			<td><input type="hidden" name="name" value="${vo.name }">
   			    <input type="hidden" name="dname" value="${vo.dname }">
				<button type="submit" name="searchbutton2"><img src ="${pageContext.request.contextPath}/images/search.png" width="30" height="30"></button></td>
			</tr>
		</table>
		</form>
			...
			<table border =0>
				<tr>
					...
					<tr class="searchrow" id="${vo.no}">
						<td rowspan=3>
						<img src="${pageContext.request.contextPath}/images/lawyer1.jpg">
						</td>
						<td>
						
						<!-- <a href="javascript:sendChildValue('${vo.name}')"> -->
						<form name="writeform" action ="lawyer_search_select.do?no=${vo.no}" target="review_write.do" method="post">
