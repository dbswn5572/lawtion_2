...
<title>Insert title here</title>
		...
		$(document).ready(function(){
			...
			$(".law").click(function(){
				var no = $(this).attr("id");
				parent.ifram2.location.href="${pageContext.request.contextPath}/introduce_right.do?no="+no;
			...
			jQuery('#ampaginationsm').on('am.pagination.change',function(e){
				  //jQuery('.showlabelsm').text('The selected page no: '+e.page);
		           $(location).attr('href', "${pageContext.request.contextPath}/introduce_left.do?page="+e.page);         
