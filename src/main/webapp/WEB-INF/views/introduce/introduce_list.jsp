...
<script>
		$(document).ready(function(){
			...
			$(".law").click(function(){
				var no = $(this).attr("id");
				$(location).attr('href','${pageContext.request.contextPath}/introduce_lawer2.do?no='+no);
			...
			jQuery('#ampaginationsm').on('am.pagination.change',function(e){
				  //jQuery('.showlabelsm').text('The selected page no: '+e.page);
		           $(location).attr('href', "${pageContext.request.contextPath}/introduce_list.do?rpage="+e.page);         
		    });
