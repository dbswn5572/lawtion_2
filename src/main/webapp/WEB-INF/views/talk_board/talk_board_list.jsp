...
<script>
	$(document).ready(function(){
		...
		jQuery('#ampaginationsm').on('am.pagination.change',function(e){
	           ...
	           $(location).attr('href', "${pageContext.request.contextPath}/talk_board.do?rpage="+e.page);         
	    });
	...
	<div class="review">
		...
		<div class="review-allbest">
			...
			<table border=0 class="best">
				...
				<tr>
					<td>${vo.rno }</td>
					<td><a href="${pageContext.request.contextPath}/talk_board_content.do?no=${vo.no }&rno=${vo.rno }" style='color:black;'>${vo.title }</a></td>
				</tr>
				</c:forEach>
			</table>
		</div>
