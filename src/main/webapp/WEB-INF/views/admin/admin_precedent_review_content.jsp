            ...
            <tr>
                  <td colspan=3>
                     <div class="write_button">
                        <a href="${pageContext.request.contextPath}/admin_precedent_review_update.do?no=${no}&rno=${rno}"><button type="submit" id="writesucess" name="writesucess">수정하기</button></a>
                        <a href="${pageContext.request.contextPath}/admin_precedent_review_delete.do?no=${no}&rno=${rno}"><button type="reset" name="reset">삭제하기</button></a>
                        <a href="${pageContext.request.contextPath}/admin_precedent_review.do"><button type="button">목록으로</button></a>
                     </div>
                  </td>
               </tr>
         </table>
