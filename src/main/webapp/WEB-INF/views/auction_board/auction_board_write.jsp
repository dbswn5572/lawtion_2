			...
			<section class="auction_style">
				...
				<table class="auction_table_write">
					...
					<tr>
						<td>내용</td>
						<td>
						<textarea rows="15" cols="60" name="content" id="content" placeholder="음란, 저작권 침해, 명예회손, 청소년 유해물, 기타 위법 자료, 허위사실 등을 게시하면 해당 게시물은 경고 없이 삭제되며, 게시자는 법률에 따라 징역형 또는 벌금형에 처해질 수 있습니다.
...
작성되는 글의 내용은 최대 1MB 까지 작성 가능합니다."></textarea></td>
					...
					<tr>
						<td>공개설정</td>
						<td><input type="hidden" name="fname" id="fname"><input type="hidden" name="id" id="id" value="${sid}"><input type="checkbox" name="agree" id="agree" class="agree-checkbox"><span>체크하시면 일반 회원들도 열람이 가능합니다.</span></td>
					</tr>
				...
				<tr>
					<td colspan="2" class="abw_success">
						<button type="submit" id="writesuccess">완료</button>
