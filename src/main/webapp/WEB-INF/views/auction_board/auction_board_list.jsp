...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/button1.css">
	...
	$(document).ready(function(){
		...
		jQuery('#ampaginationsm').on('am.pagination.change',function(e){
			  // jQuery('.showlabelsm').text('The selected page no: '+e.page);			
	           $(location).attr('href', "${pageContext.request.contextPath}/auction_board.do?rpage="+e.page);         
	    });
		...
		$(".searchButton").click(function(){
	    	...
	    	location.href = "${pageContext.request.contextPath}/auction_board.do?input="+encodeURI(input,"UTF-8")+
