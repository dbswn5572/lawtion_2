...
public interface AuctionBoardDAO {
   ...
   public ArrayList<AuctionCommentVO> getReplyListBiddingIdLawyerPast(String sid);
   public ArrayList<AuctionCommentVO> getReplyListBiddingIdLawyer(String sid);
   public int getPastBiddingCount(String sid);
   public ArrayList<AuctionCommentVO> getPastBidding(String sid);
   public int getBiddingSuccessBoard(String sid);
   public int getBiddingSuccess(String lid);
   public AuctionCommentVO getReplyBiddingId(String no);
   public int WhatNo(String id);
   ...
   public AuctionBoardVO getResultVOId(String id);
   public int getResultVOCount(String id);
   /*{
      AuctionBoardVO vo = new AuctionBoardVO();
   ...
   public ArrayList<AuctionCommentVO> getReplyListBidding(String lid);
   public ArrayList<AuctionCommentVO> getReplyListBiddingNo(String no);
   /*{
